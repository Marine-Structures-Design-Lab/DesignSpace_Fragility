...
class exploreSpace:
    ...
    def fixedExplore(self):
        ...
        if self.it < 0.2*self.itm:
            return max(int(0.20*time_rem),max(self.rt))
        elif self.it < 0.35*self.itm:
            return max(int(0.18*time_rem),max(self.rt))
        elif self.it < 0.5*self.itm:
            return max(int(0.15*time_rem),max(self.rt))
        elif self.it < 0.6*self.itm:
            return max(int(0.12*time_rem),max(self.rt))
        elif self.it < 0.7*self.itm:
            return max(int(0.10*time_rem),max(self.rt))
        elif self.it < 0.8*self.itm:
            return max(int(0.07*time_rem),max(self.rt))
        elif self.it < 0.9*self.itm:
            return max(int(0.04*time_rem),max(self.rt))
        else:
            return max(self.rt)
